...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.2.0/x64-mswin64_120")
  ...
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "x64-msvcr120-ruby220"
  ...
  CONFIG["configure_args"] = "--with-make-prog=nmake --enable-shared --with-baseruby=E:\\Ruby22-x64\\bin\\ruby.exe"
