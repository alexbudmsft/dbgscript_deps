...
module RbConfig
  ...
  CONFIG["RUBY_INSTALL_NAME"] = "ruby"
  CONFIG["RUBY_SO_NAME"] = "x64-msvcr120-ruby230"
  CONFIG["SHELL"] = "$(COMSPEC)"
  CONFIG["BUILD_FILE_SEPARATOR"] = "\\"
  CONFIG["PATH_SEPARATOR"] = ";"
  CONFIG["CFLAGS"] = "-MD -Z7 -W2 -wd4996 -we4028 -we4142 -WX -O2sy-  -Zm600"
  CONFIG["WERRORFLAG"] = "-WX"
  CONFIG["DEFS"] = ""
  CONFIG["CPPFLAGS"] = " -D_WIN32_WINNT=0x0600  "
  CONFIG["CXXFLAGS"] = "-MD -Z7 -W2 -wd4996 -we4028 -we4142 -WX -O2sy-  -Zm600"
  CONFIG["FFLAGS"] = ""
  ...
  CONFIG["configure_args"] = "--with-make-prog=nmake --enable-shared --prefix=E:\\ruby_dev --with-baseruby=E:\\Ruby22-x64\\bin\\ruby.exe --disable-install-doc --embed-debug --with-static-linked-ext"
