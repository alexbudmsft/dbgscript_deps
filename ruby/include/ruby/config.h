...
#define LIBRUBY_SO "x64-msvcr120-ruby220.dll"
#define RUBY_PLATFORM "x64-mswin64_120"
#define RUBY_SITEARCH "x64-msvcr120"
#if 0
!if "x64-msvcr120-ruby220"!="$(RUBY_SO_NAME)" || "x64-mswin64_120"!="$(ARCH)-$(PLATFORM)"
config.h: nul
!endif
#endif
